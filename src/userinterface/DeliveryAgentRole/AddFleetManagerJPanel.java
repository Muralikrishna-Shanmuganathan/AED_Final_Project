...
import Business.Role.FleetManagerRole;
 ...
 */
public class AddFleetManagerJPanel extends javax.swing.JPanel {
    ...
    UserAccount user;
    public AddFleetManagerJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.system = system;
        populateFleetManagerTable();
    }
    ...
    private void initComponents() {
        ...
        tblFleetManagers = new javax.swing.JTable();
        ...
        tblFleetManagers.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(tblFleetManagers);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        int selectRow = tblFleetManagers.getSelectedRow();

        if (selectRow >= 0) {
            String username = (String) tblFleetManagers.getValueAt(selectRow, 1);
            String pwd = (String) tblFleetManagers.getValueAt(selectRow, 2);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        int selectedRow = tblFleetManagers.getSelectedRow();
        if (selectedRow >= 0) {
            int selectionButton = JOptionPane.YES_NO_OPTION;
            int selectionResult = JOptionPane.showConfirmDialog(null, "Are you sure to delete??", "Warning", selectionButton);
            if (selectionResult == JOptionPane.YES_OPTION) {
                String username = (String) tblFleetManagers.getValueAt(selectedRow, 1);
                String pwd = (String) tblFleetManagers.getValueAt(selectedRow, 2);
                UserAccount user = system.getUserAccountDirectory().authenticateUser(username, pwd);

                //UserAccount user = (UserAccount) networkJTable.getValueAt(selectedRow, 0);
                system.getUserAccountDirectory().deleteUserAccount(user);
                system.getFleetManagerDirectory().deletePerson(user.getUsername());
    ...
    private javax.swing.JTable tblFleetManagers;
    private javax.swing.JTextField txtName;
    private javax.swing.JPasswordField txtPassword;
    private javax.swing.JTextField txtUserName;
    // End of variables declaration//GEN-END:variables

    private void populateFleetManagerTable() {
    DefaultTableModel model = (DefaultTableModel) tblFleetManagers.getModel();
        ...
        for (UserAccount user : system.getUserAccountDirectory().getUserAccountList()) {
            ...
            if ("Business.Role.FleetManagerRole".equals(user.getRole().getClass().getName())) {
